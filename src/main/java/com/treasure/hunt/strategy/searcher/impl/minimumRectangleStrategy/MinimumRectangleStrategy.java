 ...
 * The strategy applies S on each step but decreases the current rectangle of the strategy
 * (if the previous hint was not bad) to the minimum rectangle where D is inside and
 ...
 * uses a more efficient RectangleScan Routine.
 * <p>
    ...
    public SearchPath move() {
        ...
        StatusMessageItem visualisationMessage = new StatusMessageItem(StatusMessageType.EXPLANATION_VISUALISATION_SEARCHER,
                "The previous hint is visualized by a brown area which covers the area the treasure is not in.\n" +
                        ...
                        "\n" +
                        "The area, where the treasure must lie in if it is in the current phase, is drawn in turquoise color.\n" +
                        "(In the explanation of the strategy this area is called D.)"
        );
