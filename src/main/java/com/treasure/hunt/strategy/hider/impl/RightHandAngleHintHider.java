...
@Preference(name = PreferenceService.ANGLE, value = Math.PI)
public class RightHandAngleHintHider implements Hider<AngleHint> {
    ...
    public AngleHint move(SearchPath searchPath) {
        ...
        double angle = PreferenceService.getInstance().getPreference(PreferenceService.ANGLE, Math.PI * 2).doubleValue();
